...
def crear_df_comparadores():
  ...
  df = pd.DataFrame(
      data=[
        ...
        [1.00,     0.02272,     97624, 0.0000001099, 15.712, 0.000002977,    5.65,  842280, 100, 3600, 95.5],
        [0.000089, 0.016279920, 33612, 0.02588,      5.31,   0.000000125313, 6260,  241500, 600, 3600, 573.3],
        [0.000110, 0.015806875, 40274, 0.02588,      5.31,   0.000000125313, 6260,  241500, 600, 3600, 573.3]

        
      ],
      columns=["k0", "efe", "Cn", "w", "Q0", "lambda", "Er", "t_dec", "t_real", "t_irr", "t_vivo" ],
      #index=["Au", "Co", "Mo"]
      index=["Au", "Zr724", "Zr756"]
    )
  return df
