...
def crear_df_comparadores():
  ...
  df = pd.DataFrame(
      data=[
        ...
        #
         # 
        #[1.00,      0.02272,     97624,  0.00001099,   15.712, 0.000002977,    5.65,  842280, 100, 3600, 95.5], #Au
        #[0.000089,  0.016279920, 33612,  0.02588,      5.31,   0.000000125313, 6260,  241500, 600, 3600, 573.3], # Zr95 724
        #[0.0000124, 0.016053201, 128213, 0.02588,      251.6,  0.0000115018,   338,   241500, 600, 3600, 573.3] #Zr97 743
  #73886
        #08/01/2026
        [1.00,      0.02272,     112848,  0.00002297, 15.712, 0.000002977,     5.65,  85740, 1000.1, 3670, 993],
        [0.000089,  0.016279920, 36801,   0.0494,    5.31,   0.000000125313,  6260,  13620, 50000,  3670, 49550.7],
        [0.0000124, 0.016053201, 1117225, 0.0494,    251.6,  0.0000115018,    338,   13620, 50000,  3670, 49550.7]
##
      ],
...
def conc(df_muestra, w,td_i,ti_i,tv_i,tr_i, df_comp_Au, w_Au,td_c_Au,ti_c_Au,tv_c_Au,tr_c_Au, alfa, f, geometria):
  ...
  Aesp_c_Au = Aesp(np.float64(Cn_c_Au), w_c_Au, np.float64(lam_c_Au), tr_c_Au, td_c_Au, ti_c_Au, tv_c_Au, np.float64(e_c_Au))
